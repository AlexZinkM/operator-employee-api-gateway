...
import ru.uniteller.operator_employee_api_gateway.config.TAX_SERVICE_PATH
import kotlin.test.Test

@WebFluxTest
class TaxSecurityTest {
...
//    private lateinit var webClient: WebClient
    ...
    @Test
    @WithMockUser(roles = ["OPERATOR_SPECIALIST"])
    fun `should return 200 for authorized user`() {
        webTestClient.get()
            .uri(TAX_SERVICE_PATH)
